...
def plotear_histograma(nombre_de_archivo , tipo = 'serial' , color = 'g'):
    lista = calcular_histograma(f"{nombre_de_archivo}.npy")
    graficar_histograma( lista , f"hist_{tipo}_{nombre_de_archivo}.png" , color)
    print(f"Se generó la imagen hist_{tipo}_{nombre_de_archivo}.png correctamente")
...
if __name__ == '__main__':
    ...
    print(f"SpeedUp = {SpeedUp} / El código en serie es más rápido que el código en paralelo")
    print("Esto se debe a que como son archivos pequeños ahora (ya no se trabaja con la versión x2), generar las imágenes de los histogramas en serie no toma tanto tiempo. Por otro lado, en teoría, generar las imágenes usando multiprocesos debería ser más rápido. Sin embargo, por el hecho de crear e instanciar varios procesos se genera tiempo adicional, el cual no se desprecia por tratarse de una tarea muy rápida. Por lo tanto, es correcto que el tiempo de ejecución en serie sea más rápido que el tiempo de ejecución usando multiprocesos")
